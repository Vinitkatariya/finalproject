...
class SearchSell extends StatefulWidget {
  @override
  _SearchSellState createState() => _SearchSellState();
}

class _SearchSellState extends State<SearchSell> {
  ...
  Future<Void> getAddsOfBatai1(city) async {
    try {
      await _firestore.collection('Sell').get().then((querySnapshot) {
